...
export default async function AlbumPage({params}: {params: {id: string}}) {
  ...
  return (
    <main className="mt-24 flex items-center justify-between basis-full px-6 gap-[5.42%]">
      ...
      <div className="relative w-[calc(100vw-72.22vw)] h-[calc(100vw-72.22vw)] basis-1/3">
        <Image
